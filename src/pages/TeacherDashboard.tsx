            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className={cn(
                    "px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1 cursor-pointer shadow-sm active:scale-95",
                    isLibraryExpanded
                        ...
                        <div key={deck.id} className="flex flex-col sm:flex-row justify-between sm:items-center p-3 gap-3 bg-stone-200/60 dark:bg-zinc-800/50 rounded-xl border border-amber-600/20 dark:border-amber-500/30">
                          <div className="flex items-start gap-3 flex-1 min-w-[150px]">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="text-xs opacity-60 flex flex-wrap items-center gap-1.5 mt-1">
                                <span>Số thẻ: {deck.cards?.length || 0}</span>
                                <span className="inline-block px-1.5 py-0.5 rounded text-[10px] font-mono font-bold uppercase bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20">
                                  {(() => {
