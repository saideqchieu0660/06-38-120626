...
import { Play, BookOpen, Search, X, ChevronLeft, ChevronRight } from 'lucide-react';
...
export const DeckList = ({ decks, showSearch = true, groupBySubject = false }: DeckListProps) => {
