...
export default function FlashcardViewer({ deckId, userId, deckCards }: FlashcardViewerProps) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-4 sm:p-8 w-full max-w-2xl mx-auto space-y-6">
      ...
      {/* Card UI */}
      <div className="w-full aspect-[4/3] sm:aspect-[3/2] bg-white dark:bg-zinc-900 border border-stone-200 dark:border-zinc-800 rounded-3xl shadow-xl flex flex-col items-center justify-center text-center p-8 sm:p-12">
